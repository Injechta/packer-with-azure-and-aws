...
Cette page est destinée à être déployée sur une machine virtuelle dans Azure, via Terraform, rendant ces informations accessibles via un navigateur web. La configuration Terraform utilisée pour déployer cette machine virtuelle est détaillée ci-dessous :
